  ...
  return (
    <>
      ...
      <div className="side-icon">
        <i class="fal fa-arrow-to-top s-icon"></i>
        <i class="fab fa-facebook-square s-icon"></i>
        <i class="fab fa-twitter s-icon"></i>
        <i class="fab fa-whatsapp s-icon"></i>
        <i class="fab fa-flickr s-icon"></i>
      </div>
      ...
      <div className="row card">
        <div className="col-4">
          <img
            className="card-img"
            src="https://images.unsplash.com/photo-1496449903678-68ddcb189a24?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDZ8fGZ1bnxlbnwwfHx8fDE2MjkxODMwMTM&ixlib=rb-1.2.1&q=80&w=2000"
          />
        ...
        <div className="col-4">
          ...
          <div className="card-body">
            ...
            <h2 className="card-text">
              It's time for teens to open shop on Instagram! 🛍️
            </h2>
